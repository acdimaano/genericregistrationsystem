                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <div class="element">
                            ...
                            <div class="space"></div>
                            <p><a href="doctor_patientqueue.php" class="btn btn-punch btn-white hover-primary hover-colors btn-sm" role="button">Patient Queue</a> <a href="doctor_patientdone.php" class="btn btn-punch btn-primary btn-sm btn-darker" role="button">Patient Done</a>
                            </p>
                        </h1></div>
                    </div>
                </div>
